...
// Frozen copy of the pre-serialization exp(value) datapath used by the
// Softmax equivalence reference.  Keep this module under sim/ only: production
// is free to replace the combinational Horner tree with a time-shared core.
module vit_fp32_exp_neg_comb_reference (
