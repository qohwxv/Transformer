...
patterns = [
    ...
    r"M7_MODE3_E04_RESULT class=879 logit=414886a0 logit_real=[-+]?[0-9]+\.[0-9]+ numerical_status=PENDING_EXTERNAL_BEHAVIORAL_AND_M6_ORACLES",
    r"M7_MODE3_E04_TRAFFIC cycles=9010564 logical_reads=1694368 cache_hits=767234 external_u32=927134 ar=207134 r_beats=351134 full_r_beats=192000 narrow_r_beats=159134 linefills=48000 line_hits=720000 writes=154064",
    r"VIT_PHASE_E_AXI_E04_MODE3_REAL_RTL_STRUCTURAL_PASS checks=202 cycles=9010605 commands=5 external_u32=927134 writes=154064 model_reads=771534 scratch_reads=155600 class=879 logit=414886a0 numerical_status=PENDING_EXTERNAL_BEHAVIORAL_AND_M6_ORACLES",
]
positions = []
