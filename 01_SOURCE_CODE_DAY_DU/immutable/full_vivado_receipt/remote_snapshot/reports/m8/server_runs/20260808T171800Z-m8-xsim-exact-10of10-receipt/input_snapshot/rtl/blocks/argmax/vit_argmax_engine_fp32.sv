...
module vit_argmax_engine_fp32 (
    ...
    logic compare_a_greater;

    // Keep IEEE-754 ordering in one reusable arithmetic leaf.  The engine
    // remains responsible only for stream control and first-index tie policy.
    vit_fp32_compare u_value_compare (
        .a               (input_data),
        .b               (best_value),
        .a_is_nan        (),
        .a_is_inf        (),
