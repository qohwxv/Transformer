...
module tb_m8_memory_subsystem_gemm_wide_write_stride;
    ...
    initial begin
        ...
        // M7.3C non-contiguous GEMM result row stride:
        //
        // addr =
        // RESULT_BASE + row*4 + column
        //
        // Each row contains two valid result words followed
        // by two untouched gap words.
        active_cmd.immediate = 32'd4;
        ...
        // Clear destination + inter-row gap region.
        ...
        fork
            ...
            begin : MAIN_SEQUENCE
                ...
                // =================================================
                // M7.3C non-contiguous stride verification
                // =================================================
                for (i = 0; i < 8; i = i + 1) begin
                    ...
                    if (
                        ...
                        $display(
                            "FAIL M7.3C row=%0d col=0 got=%08h",
                            i,
                            u_ddr.peek_u32(
                                SCRATCH_BASE +
                                ((RESULT_BASE + i*4) << 2)
                    ...
                    if (
                        ...
                        $display(
                            "FAIL M7.3C row=%0d col=1 got=%08h",
                            i,
                            u_ddr.peek_u32(
                                SCRATCH_BASE +
                                ((RESULT_BASE + i*4 + 1) << 2)
                    ...
                    if (
                        ...
                        $display(
                            "FAIL M7.3C gap row=%0d offset=2 modified",
                            i
                        );
                        $fatal(1);
                    end
                    ...
                    if (
                        ...
                        $display(
                            "FAIL M7.3C gap row=%0d offset=3 modified",
                            i
                        );
                        $fatal(1);
                    end
                ...
                $display(
                    "PASS: M7.3C non-contiguous stride writeback correct"
                );
                ...
                if (logical_write_count != 16) begin
                    $display(
                        "FAIL: expected 16 logical writes"
                    );
                    $fatal(1);
                end
                ...
                if (aw_count != 16) begin
                    $display(
                        "FAIL: expected 16 scalar AW for M7.3C stride"
                    );
                    $fatal(1);
                end
                ...
                if (w_count != 16) begin
                    $display(
                        "FAIL: expected 16 scalar W for M7.3C stride"
                    );
                    $fatal(1);
                end
                ...
                if (b_count != 16) begin
                    $display(
                        "FAIL: expected 16 B responses for M7.3C stride"
                    );
                    $fatal(1);
                end
