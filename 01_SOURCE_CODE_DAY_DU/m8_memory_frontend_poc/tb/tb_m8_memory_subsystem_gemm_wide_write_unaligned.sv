...
module tb_m8_memory_subsystem_gemm_wide_write_unaligned;
    ...
    localparam logic [31:0] RESULT_BASE = 32'd1025;
    ...
    initial begin
        ...
        fork
            ...
            begin : MAIN_SEQUENCE
                ...
                if (aw_count != 7) begin
                    $display(
                        "FAIL: expected 7 AW for M7.3A unaligned"
                    );
                    $fatal(1);
                end
                ...
                if (w_count != 7) begin
                    $display(
                        "FAIL: expected 7 W for M7.3A unaligned"
                    );
                    $fatal(1);
                end
                ...
                if (b_count != 7) begin
                    $display(
                        "FAIL: expected 7 B responses for M7.3A unaligned"
                    );
                    $fatal(1);
                end
