...
module tb_m8_memory_subsystem_gemm_wide_write_tail;
    ...
    initial begin
        ...
        fork
            ...
            begin : MAIN_SEQUENCE
                ...
                // =================================================
                // M7.3D tail verification
                //
                // write_word_count = 14:
                //   result[0..13] must commit
                //   result[14..15] must stay untouched
                // =================================================
                for (i = 0; i < 14; i = i + 1) begin
                    if (
                        ...
                        $display(
                            "FAIL M7.3D RESULT[%0d] exp=%08h got=%08h",
                            i,
                            32'hCC00_0000 + i,
                            u_ddr.peek_u32(
                                SCRATCH_BASE +
                ...
                for (i = 14; i < 16; i = i + 1) begin
                    if (
                        ...
                        $display(
                            "FAIL M7.3D TAIL RESULT[%0d] modified",
                            i
                        );
                        $fatal(1);
                    end
                ...
                $display(
                    "PASS: M7.3D tail writeback correct"
                );
                ...
                if (logical_write_count != 14) begin
                    $display(
                        "FAIL: expected 14 logical writes for M7.3D tail"
                    );
                    $fatal(1);
                end
                ...
                if (aw_count != 5) begin
                    $display(
                        "FAIL: expected 5 AW for M7.3D tail"
                    );
                    $fatal(1);
                end
                ...
                if (w_count != 5) begin
                    $display(
                        "FAIL: expected 5 W for M7.3D tail"
                    );
                    $fatal(1);
                end
                ...
                if (b_count != 5) begin
                    $display(
                        "FAIL: expected 5 B responses for M7.3D tail"
                    );
                    $fatal(1);
                end
