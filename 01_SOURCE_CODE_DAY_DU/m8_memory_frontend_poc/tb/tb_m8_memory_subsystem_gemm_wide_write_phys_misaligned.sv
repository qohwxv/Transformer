...
module tb_m8_memory_subsystem_gemm_wide_write_phys_misaligned;
    ...
    localparam logic [63:0] SCRATCH_BASE = 64'h0004_0004;
    ...
    localparam logic [31:0] A_BASE    = 32'd255;
    ...
    initial begin
        ...
        fork
            ...
            begin : MAIN_SEQUENCE
                ...
                // =================================================
                // Verify all 16 fake result words reached DDR
                // =================================================
                for (i = 0; i < 16; i = i + 1) begin
                    ...
                    if (
                        ...
                        $display(
                            "FAIL RESULT[%0d] exp=%08h got=%08h",
                            i,
                            32'hCC00_0000 + i,
                            u_ddr.peek_u32(
                                SCRATCH_BASE +
                ...
                $display(
                    "PASS: 16 GEMM result words committed"
                );
                ...
                if (aw_count != 16) begin
                    $display(
                        "FAIL: expected 16 AW for M7.3E physical misalignment"
                    );
                    $fatal(1);
                end
                ...
                if (w_count != 16) begin
                    $display(
                        "FAIL: expected 16 W for M7.3E physical misalignment"
                    );
                    $fatal(1);
                end
                ...
                if (b_count != 16) begin
                    $display(
                        "FAIL: expected 16 B responses for M7.3E physical misalignment"
                    );
                    $fatal(1);
                end
