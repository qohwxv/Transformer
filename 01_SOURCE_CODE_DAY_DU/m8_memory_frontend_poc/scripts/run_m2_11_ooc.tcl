...
set OUT \
"$ROOT/results/optimized/m2_11_ooc"
...
puts ""
puts "============================================================"
puts " M2.11 OOC POST-ROUTE @ 50 MHz"
puts "============================================================"
...
set fp [open "$OUT/M2_11_OOC_SUMMARY.txt" w]

puts $fp "M2.11 OOC POST-ROUTE"
puts $fp "TOP=$TOP"
puts $fp "PART=$PART"
