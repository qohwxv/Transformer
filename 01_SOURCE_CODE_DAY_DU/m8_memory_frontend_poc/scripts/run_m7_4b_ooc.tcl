...
set OUT \
"$ROOT/results/optimized/m7/M7_4B_OOC"
...
puts ""
puts "============================================================"
puts " M7.4B OOC POST-ROUTE @ 50 MHz"
puts "============================================================"
...
set fp [open "$OUT/M7_4B_OOC_SUMMARY.txt" w]

puts $fp "M7.4B OOC POST-ROUTE"
puts $fp "TOP=$TOP"
puts $fp "PART=$PART"
