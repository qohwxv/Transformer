...
set OUT \
"$ROOT/results/optimized/m3/m3_2a_ooc"
...
puts ""
puts "============================================================"
puts " M3.2A OOC POST-ROUTE @ 50 MHz"
puts "============================================================"
...
set fp [open "$OUT/M3_2A_OOC_SUMMARY.txt" w]

puts $fp "M3.2A OOC POST-ROUTE"
puts $fp "TOP=$TOP"
puts $fp "PART=$PART"
